#' Import data and metadata from XRD Commander exported TXT files
#'
#' Reads TXT files with one or multiple ranges (XRD commander "save as txt")
#'
#' @param txtfile path to TXT file
#'
...
mraw2df <- function(txtfile) {
   ...
   sampleid <- common::ProvideSampleId(txtfile)
